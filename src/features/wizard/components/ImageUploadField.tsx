    ...
    if (value && !showUrlInput) {
        return (
            <div>
                ...
                <div style={{ position: 'relative', borderRadius: '8px', overflow: 'hidden', border: '1px solid #2a3050' }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={value} alt="" style={{ width: '100%', height: '120px', objectFit: 'cover', display: 'block' }} />
                ...
                {uploading && <p style={statusSt}><Loader2 style={{ width: '12px', height: '12px', animation: 'spin 1s linear infinite' }} /> Subiendo...</p>}
            </div>
        )
    }
    ...
    return (
        <div>
            ...
            >
                {uploading ? (
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
                        <Loader2 style={{ width: '20px', height: '20px', color: '#00c8ff', animation: 'spin 1s linear infinite' }} />
                        <p style={{ fontSize: '12px', color: '#8b9ec7', margin: 0 }}>Subiendo imagen...</p>
                    </div>
                ) : (
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
                        <Upload style={{ width: '20px', height: '20px', color: '#5d7099' }} />
                        <p style={{ fontSize: '12px', color: '#8b9ec7', margin: 0 }}>
                            Arrastra una imagen o <span style={{ color: '#00c8ff', fontWeight: 700 }}>haz clic</span>
                        </p>
                        <p style={{ fontSize: '10px', color: '#3d4f6e', margin: 0 }}>PNG, JPG, WebP · Máx 5MB</p>
                    </div>
                )}
            </div>
            <input ref={fileRef} type="file" accept="image/*" onChange={onFileChange} style={{ display: 'none' }} />
            ...
            <button
                ...
                style={{ display: 'flex', alignItems: 'center', gap: '4px', marginTop: '6px', padding: 0, background: 'none', border: 'none', color: '#5d7099', fontSize: '11px', cursor: 'pointer', fontFamily: 'inherit' }}
            >
...
const labelSt: React.CSSProperties = {
    ...
    color: '#8b9ec7', marginBottom: '7px',
}

const inputSt: React.CSSProperties = {
    flex: 1, padding: '10px 14px', borderRadius: '8px',
    background: '#0d1124', border: '1px solid #2a3050',
...
const smallBtn: React.CSSProperties = {
    ...
    background: '#151d38', border: '1px solid #2a3050',
    color: '#8b9ec7', cursor: 'pointer', display: 'flex',
    alignItems: 'center', justifyContent: 'center', flexShrink: 0,
}

const statusSt: React.CSSProperties = {
    display: 'flex', alignItems: 'center', gap: '6px',
    fontSize: '11px', color: '#00c8ff', marginTop: '6px',
}
