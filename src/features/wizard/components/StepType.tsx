...
import { Video, FileText, BookOpen, ArrowRight, Layers } from 'lucide-react'
        ...
        >
            ...
            <div style={{ maxWidth: '900px', margin: '0 auto', padding: '48px 24px' }}>
                ...
                <div style={{ marginBottom: '40px' }}>
                    ...
                    <p style={{ fontSize: '14px', color: '#5d7099', marginTop: '6px' }}>
                        Nombre, modo visual y tipo de estructura.
                    </p>
                </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <div
                            role="radiogroup"
                            aria-labelledby="visual-model-label"
                            style={{
                                display: 'grid',
                                gridTemplateColumns: '1fr 1fr',
                                gap: '10px',
                        ...
                        return (
                            <button
                                ...
                                onMouseEnter={(e) => {
                                    if (!isSelected) {
                                        e.currentTarget.style.borderColor = '#2a3050'
                                        e.currentTarget.style.background = '#131829'
                                    }
                                }}
                                onMouseLeave={(e) => {
                                    if (!isSelected) {
                                        e.currentTarget.style.borderColor = '#1e2847'
                                        e.currentTarget.style.background = '#0f1425'
                                    }
                                }}
                            >
                                {/* Icon */}
                                        ...
                                        >
                                            <span
                                                style={{
                                                    ...
                                                    borderRadius: '50%',
                                                    flexShrink: 0,
                                                    background: isSelected ? '#FF007F' : '#2a3050',
                                                }}
                                            />
                                            {s.label}
                                        </li>
                ...
                {/* Libre card */}
                {(() => {
                    const isLibre = structureType === 'libre'
                    return (
                        <button
                            onClick={() => setStructureType('libre' as ProjectStructureType)}
                            style={{
                                width: '100%',
                                textAlign: 'left',
                                padding: '20px 24px',
                                ...
                                fontFamily: 'inherit',
                                marginBottom: '32px',
                                background: isLibre ? 'rgba(0,200,255,0.06)' : 'transparent',
                                border: isLibre
                        ...
                        >
                            <div
                                style={{
                                    ...
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    background: isLibre ? 'rgba(0,200,255,0.15)' : '#151d38',
                                    color: isLibre ? '#00c8ff' : '#5d7099',
                                }}
                            >
                            ...
                            <div style={{ flex: 1 }}>
                                ...
                                >
                                    Lienzo en blanco. Empezás con hero y agregás exactamente los
                                    bloques que necesitás, en el orden que querés.
                                </p>
                            </div>
                            {isLibre && (
                                <div
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                    <button
                        ...
                        style={{
                            ...
                            opacity: projectName.trim() ? 1 : 0.3,
                            fontFamily: 'inherit',
                        }}
                    >
