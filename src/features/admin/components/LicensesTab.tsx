                                ...
                                <Td>
                                    <div className="flex gap-1.5">
                                        ...
                                        {l.status === 'revoked' && (
                                            <button
                                                title="Revocada"
                                                className="p-1.5 rounded opacity-40 cursor-default"
                                                aria-label="Revocada"
                                                style={{ color: 'var(--text-muted)' }}
                                            >
            ...
            {editTarget && (
                <LicenseFormModal
                    ...
                    initial={{
                        ...
                        expires_at: editTarget.expires_at?.split('T')[0] ?? '',
        ...
        <AdminModal title={title} onClose={onClose}>
            {editMode && licenseKey ? (
                ...
                <p className="text-xs mb-4" style={{ color: 'var(--text-muted)' }}>
                    La clave de licencia se generará automáticamente.
                </p>
            )}
            <form
                onSubmit={(e) => {
